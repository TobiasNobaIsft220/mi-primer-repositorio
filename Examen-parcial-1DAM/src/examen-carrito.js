...
function agregarProductos() {
    ...
    let validacionAgregarProducto = 0;
    let idProductoSolicitado;
    let nombreProducto;
    let cantidadProducto;
    let cantidadProductoSolicitado;
    let agregarProductoCarrito;
    ...
    variableReadline.question(`Elija el numero del producto que desee agregar al carrito: `, (producto) => {
        //Question para que el usuario elija la cantidad del producto que desea agregar al carrito.
        variableReadline.question(`Elija la cantidad de productos Numero ${producto} que desee comprar: `, (cantidad) => {
...
function modificarProductos() {
    ...
    let validacionModificarProducto = 0;
    ...
    if (carrito.length > 0) {
        ...
        variableReadline.question(`Elija la ID del producto que quiera modificar: `, (producto) => {
            //Question para que el usuario elija la cantidad que va a agregar o quitar del producto que desee.
            variableReadline.question(`Elija la cantidad que quiera agregar o eliminar a este producto: `, (cantidad) => {
                ...
                variableReadline.question(`Presione la tecla Enter para salir del carrito de compras.`, (salir) => {
...
function descuentos(subtotalFinalFuncion) {
