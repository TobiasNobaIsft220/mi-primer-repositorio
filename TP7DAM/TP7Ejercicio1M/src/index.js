...
let cantidadLibroProfesor = 0;
let cantidadLibroEstudiante = 0;
let cantidadLibroGeneral = 0;
...
function calcularMulta(diasRetraso, tipoUsuario, categoria) {
...
function renovacion(multafinal) {
